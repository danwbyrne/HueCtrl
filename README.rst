...
To grab the data from the screen we have a python file called screenGrab. With this we use mss and numpy to capture pixel data from the monitor and return it. Using mss over other librarys such as Pillow has two big advantages: 
